...
Summary(pl):	Serwer dºwiÍku dla WindowMaker'a
...
%description -l pl
Wmsound jest serwerem dºwiÍku dla WindowMaker'a. Aktualnie obs≥uguje
pliki .wav w formacie 8 i 16 bitowym.

%description -l pt_BR
O wmsound È o servidor de som para o Window Maker,
atualmente suporta arquivos .wav de 8 ou 16 bits.

%description -l es
wmsound es el servidor de sonido para Window Maker, actualmente
soporta archivos .wav de 8 Û 16 bits.

%package data
Summary:	Wmsound data
Summary(fr):	DonnÈes de Wmsound
...
Les donnÈes standard de Wmsound.
...
Summary(pl):	Pliki nag≥Ûwkowe dla Wmsounda
...
Wmsound biblioteket samt ´headerfilenª

%description devel -l pl
Pliki nag≥Ûwkowe i biblioteki dla Wmsounda.

%description -l pt_BR devel
Bibliotecas para construir aplicaÁıes com wmsound.

%description -l es devel
Bibliotecas y archivos de inclusiÛn, para que puedas desarrollar
